...
function M.setup()
  ...
  theme.highlights = {
    ...
    Function = { fg = c.purple, style = options.styles.functions }, -- function name (also: methods for classes)
  ...
  local markdown_rainbow = { c.magenta, c.yellow, c.green, c.teal, c.blue, c.purple }
